                        ...
                        <div class="product">
                            <figure class="product-media">
                                <a href="{{ route('product.show', $item->product->id) }}">
                                    <img src="{{ $item->product->firstImage->path ? asset('public/assets/images/demos/demo-2/products/' . $item->product->firstImage->path) : asset('public/assets/images/no-image.jpg') }}"
                                        alt="Product image">
                                </a>
                            </figure>
